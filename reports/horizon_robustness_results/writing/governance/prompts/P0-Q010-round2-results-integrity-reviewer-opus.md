...
**Your seat:** `results-integrity-reviewer/opus` (seat `plain`, slice `S3`), the same seat and evidence slice you had in round 1. You are read-only; return one ballot per addendum in reply.
